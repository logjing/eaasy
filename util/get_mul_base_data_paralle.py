...
for sp in [0, 1, 2, 3]:
    for mm in ['train','val']:
        ...
        root_path = 'E:\dataset\MSCOCO2014'
        ...
        # get data_list
        fss_list_root = 'E:/project/insight1/MIANet/lists/{}/fss_list/{}/'.format(args.data_set,
                                                                                                    args.mode)
        ...
        for line in f_str:
            ...
            mask = mask.replace("../data", "E:\dataset").replace("annotations/" + mm + "2014",
                                                                              mm + "_contain_crowd")
